...
public class TextureStorage {
    ...
    public TextureStorage(ImauDatasetManager manager, int screens, int width, int height) {
    ...
    public synchronized void requestNewConfiguration(int screenNumber, SurfaceTextureDescription newDesc) {
        ...
        for (Map.Entry<SurfaceTextureDescription, ByteBuffer> entry : legendStorage.entrySet()) {
